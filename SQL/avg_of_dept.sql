...
select e.name, e.department, e.salary, d.avg_dept_salary from employees e
join
(select department, AVG(salary) as avg_dept_salary from employees group by department) d
